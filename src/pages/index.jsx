...
export default function Home() {
  ...
  return (
    <div className="container">
      ...
      <Link href="/blog/all" className="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Feed</Link>
      <br /><br />
